        ...
        <section class="relative pt-20 sm:pt-24 pb-6 sm:pb-14 overflow-hidden mesh-gradient">
            <div class="absolute inset-0 opacity-[0.03] pointer-events-none">
                <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                    <defs><pattern id="grid-galeri" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="white" stroke-width="1"/></pattern></defs>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
                    <div class="flex-1">
                        ...
                        <h1 class="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tighter leading-tight sm:leading-[0.95] mb-2 sm:mb-4">
                            Galeri<br/>
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-rose-400 to-orange-400">Dokumentasi.</span>
                        </h1>
                        <p class="max-w-xl text-xs sm:text-sm lg:text-base text-slate-300/80 font-medium leading-relaxed">
                            Dokumentasi visual kegiatan dan momen penting di lingkungan TransDiKA Universitas Hasanuddin.
                        </p>
                    </div>
                    <div class="hidden lg:flex flex-col items-end gap-4">
                        <div class="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 text-right min-w-[120px] sm:min-w-[160px]">
                            <div class="text-3xl sm:text-4xl font-black text-white tracking-tighter leading-none">{{ $galleries->total() }}</div>
                            <div class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-2">Album Tersedia</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-3 sm:mt-5 flex items-center gap-3">
                    ...
                    <p class="text-sm font-semibold text-slate-600">
                        Menampilkan <span class="font-black text-red-600">{{ $galleries->count() }}</span> dari <span class="font-black text-slate-900">{{ $galleries->total() }}</span> galeri
                    </p>
                </div>
            </div>
        </section>
