        ...
        <div class="mt-8 sm:mt-16 w-full container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div class="group relative">
                    ...
                    <div class="relative flex items-center gap-6 bg-slate-900/40 backdrop-blur-3xl border border-white/10 p-8 rounded-t-[2rem] hover:bg-slate-900/60 transition-all duration-500">
                ...
                <!-- Stat Card 2 -->
                <div class="group relative">
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-t-[2rem] opacity-20 group-hover:opacity-100 transition duration-500 blur"></div>
                    <div class="relative flex items-center gap-6 bg-slate-900/40 backdrop-blur-3xl border border-white/10 p-8 rounded-t-[2rem] hover:bg-slate-900/60 transition-all duration-500">
                ...
                <!-- Stat Card 3 -->
                <div class="group relative">
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-t-[2rem] opacity-20 group-hover:opacity-100 transition duration-500 blur"></div>
                    <div class="relative flex items-center gap-6 bg-slate-900/40 backdrop-blur-3xl border border-white/10 p-8 rounded-t-[2rem] hover:bg-slate-900/60 transition-all duration-500">
