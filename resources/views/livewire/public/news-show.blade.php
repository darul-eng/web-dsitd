    ...
    <div class="bg-white min-h-screen flex flex-col">
        ...
        <section class="relative pt-24 pb-12 overflow-hidden mesh-gradient">
            ...
            <div class="container mx-auto px-6 relative z-10">
                <div class="flex flex-col gap-4">
                    ...
                    <h1 class="text-3xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter leading-tight max-w-4xl">
                        {{ $news->title }}
                    </h1>
        ...
        <section class="py-16 flex-grow flex flex-col">
            <div class="container mx-auto px-6 flex flex-col flex-grow">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 flex-grow">
                    <article class="lg:col-span-8 flex flex-col">
                        @if($news->cover_image)
                            <div class="rounded-[2.5rem] overflow-hidden mb-12 shadow-2xl shadow-slate-200/50">
                    ...
                    <aside class="lg:col-span-4 flex flex-col gap-8">
                        ...
                        <div class="rounded-[2rem] border border-slate-100 bg-slate-50 p-8">
                            <h3 class="text-[10px] font-black text-slate-600 uppercase tracking-widest mb-6 pb-2 border-b border-slate-200">Informasi Publikasi</h3>
                            
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    <div class="w-10 h-10 rounded-xl bg-white flex items-center justify-center border border-slate-100 text-slate-400">
                        ...
                        <div class="rounded-[2rem] bg-slate-900 p-8 text-white relative overflow-hidden group">
                            ...
                            <h3 class="text-lg font-black tracking-tight mb-4 relative z-10">Tetap Terhubung</h3>
                            <p class="text-xs text-slate-400 leading-relaxed mb-8 relative z-10">Dapatkan informasi terbaru seputar transformasi digital di Unhas langsung ke unit kerja Anda.</p>
                            <a href="mailto:it@unhas.ac.id" class="inline-flex w-full items-center justify-center py-4 bg-white text-slate-900 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-red-600 hover:text-white transition-all relative z-10">Hubungi Kami</a>
                        </div>
                    </aside>
                </div>
            </div>
